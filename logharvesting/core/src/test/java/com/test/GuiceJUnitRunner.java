...
public class GuiceJUnitRunner extends BlockJUnit4ClassRunner {
    ...
    private List<Module> getModules(Class<?> clazz) {
        ...
        if (annotation == null) return ImmutableList.of();

        Class<? extends Module>[] modules = annotation.value();

        if (modules == null || modules.length == 0) return ImmutableList.of();
        ...
        for (Class<? extends Module> module : modules) {
            ...
            try {
                ...
                throw new RuntimeException("A module class" + module.getName() + " within the @Modules annotation cannot be instantiated.", e);
            }
